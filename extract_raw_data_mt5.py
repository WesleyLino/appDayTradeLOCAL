...
def extract_from_mt5(symbol="WIN$", date_str="2026-03-10"):
    ...
    rates_m1 = mt5.copy_rates_range(symbol, mt5.TIMEFRAME_M1, dt_target_start, dt_target_end)
    ...
    ticks = mt5.copy_ticks_range(symbol, dt_target_start, dt_target_end, mt5.COPY_TICKS_ALL)
