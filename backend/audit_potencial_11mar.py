...
async def run_audit():
    ...
    logger.info(
        "1. OPORTUNIDADE PERDIDA: Filtro de Regressão vetou entradas de repique."
    )
    logger.info(
        "2. ASSERTIVIDADE: O uso de Breakeven em 60pts protegeu o capital de R$ 3k em 2 trades que voltaram."
    )
