...
async def diagnostic_sell_vetos():
    ...
    for target_date in dates_to_test:
        ...
        tester = BacktestPro(symbol=symbol, n_candles=2500, timeframe=timeframe, ai_core=ai_instance)
    ...
    if "H1_BULLISH_TREND_VETO" in counts or "MACRO_BULL_BLOCK" in counts:
        print("Fator Principal: O mercado estava em forte tendência de alta (Bullish) nos tempos maiores.")
        print("A IA agiu corretamente ao vetar vendas contra a tendência primária, evitando stops desnecessários.")
