...
async def run_assertivity_audit():
    ...
    trades_today = [
        t for t in all_trades if pd.to_datetime(t["entry_time"]).date() == target_date
    ]
    ...
    print(
        " 2. A maioria dos vetos salvou o capital de 'violinadas' em candles de 1min."
    )
    print(
        " 3. Melhoria sugerida: Implementar 'Cross-Check M5' para validar reversões de RSI."
    )
