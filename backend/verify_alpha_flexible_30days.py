...
async def run_30day_alpha_test():
    print("📈 Iniciando Teste ALPHA de 30 Dias: Janela 10h-15h + Alpha Scaling (Lote Dinâmico)")
    ...
    for t in backtester.trades[-10:]:
        print(f"Data: {t['exit_time'].date()} | Side: {t['side']} | Lote: {t['lots']} | Pts: {t['pnl_points']:.1f} | R$: {t['pnl_fin']:.2f} | Motivo: {t['reason']}")
