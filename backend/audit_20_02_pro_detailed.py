...
async def run_detailed_audit():
    ...
    logging.info("🚀 INICIANDO AUDITORIA DETALHADA SOTA PRO (20/02/2026)")
    ...
    tester = BacktestPro(
        symbol=symbol,
        n_candles=3500, # Candles para o dia e lookback
        timeframe="M1",
    ...
    # 4. Processamento de Resultados PRO (Filtrando apenas o dia 20/02)
...
"""
    ...
    # Salva o relatório
    report_path = os.path.join(os.path.dirname(__file__), "..", "backend", "audit_pro_2002_report.md")
