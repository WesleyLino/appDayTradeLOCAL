...
async def run_detailed_audit():
    ...
    full_report = (
        "# 📊 Relatório de Auditoria Detalhada: Potencial de Ganho (19/02 - 27/02)\n"
    )
    full_report += (
        "**Configuração**: Modo de Potencial Bruto (Sniper SOTA Desbloqueado)\n"
    )
    ...
    resumo_tabela += (
        "| Data | PnL Total | Trades | Compra | Venda | Win Rate | Viés IA |\n"
    )
    resumo_tabela += "| :--- | :--- | :---: | :---: | :---: | :---: | :---: |\n"
    ...
    for target_date in dates_to_test:
        ...
        ai_instance.uncertainty_threshold_base = (
            1.0  # Ignora incerteza para auditoria de potencial
        )
        ...
        tester.opt_params["cooldown_minutes"] = (
            2  # Permite mais trades para ver potencial
        )
