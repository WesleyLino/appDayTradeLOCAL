...
async def run_multi_day_v24_4():
    ...
    logging.info(f"🚀 INICIANDO AUDITORIA DINÂMICA v24.4: 13 DIAS (FEV/MAR)")
    logging.info(f"Foco: Sensibilidade Personalizada por Cenário - PT-BR\n")
    ...
    for label, csv_path in days_to_test:
        ...
        panico_vetos = bt.shadow_signals.get('veto_reasons', {}).get('PANICO_MERCADO_SEM_BYPASS', 0)
        ...
        logging.info(f"   ✅ Resultado: PnL R$ {pnl:.2f} | Trades: {trades_count} | WR: {win_rate:.1f}% | Vetos Pânico: {panico_vetos}")
