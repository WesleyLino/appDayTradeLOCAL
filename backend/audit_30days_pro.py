...
async def run_30day_audit_massiva():
    ...
    logging.info(f"🚀 INICIANDO AUDITORIA MASSIVA DE 30 DIAS SOTA V10.0 MAESTRO III ({symbol})")
    
    # Pre-fetch de 25.000 velas M1 para cobrir ~30 dias úteis (~50 dias corridos)
    logging.info("📥 Solicitando histórico massivo do MT5 (25.000 velas), por favor aguarde...")
    ...
    logging.info(f"📊 Identificados {len(dates_to_test)} dias de pregão para auditoria.")

    full_report = "# 📊 Relatório Geral de Auditoria: 30 Dias SOTA V10.0 (Maestro III)\n"
    ...
    resumo_tabela += "| Data | PnL Total | Trades | Compra | Venda | Win Rate | Flash-Exit |\n"
    resumo_tabela += "| :--- | :--- | :---: | :---: | :---: | :---: | :---: |\n"
    ...
    report_path = os.path.join(os.path.dirname(__file__), "..", "backend", "audit_30days_results.md")
