...
def relaxed_decision(self, obi, sentiment, patchtst_score, regime=0, atr=0.0, volatility=0.0, hour=0):
    ...
    return original_decision(self, obi, sentiment, patchtst_score, regime, atr, volatility, hour)
