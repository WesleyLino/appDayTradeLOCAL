...
async def main():
    ...
    scenarios = [
        (
            "Aggressive Mode (Full Day)",
            {**base_config, "aggressive_mode": True, "use_trailing_stop": False},
        ),
        (
            "Aggressive + Sniper (10h-12h)",
            {
                **base_config,
    ...
    print("\n" + "=" * 80)
    print(
        f"{'CENÁRIO (30 DIAS)':<30} | {'LUCRO':<10} | {'DD':<8} | {'TRADES':<6} | {'WR':<6}"
    )
    print("-" * 80)
    for r in results:
        print(
