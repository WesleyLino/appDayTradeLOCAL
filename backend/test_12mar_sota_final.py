...
async def test_12mar_sota_final():
    ...
    try:
        ...
        logger.info(f"✅ Configurações v24 carregadas.")
    ...
    logger.info(f"📊 Processando simulação para {symbol} (Dia 12/03) em modo SOTA v24...")
    await bt.run()
    ...
    logger.info(f"\n" + "="*50)
    logger.info(f"🏆 RESULTADO DIA 12/03 (SOTA v24)")
    logger.info(f"==================================================")
