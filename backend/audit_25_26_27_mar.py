...
async def run_audit():
    ...
    logging.info(f"🚀 INICIANDO AUDITORIA PARA CALIBRAGEM MÁXIMA E POTENCIAL - SOTA ({symbol}) nos dias 25, 26, 27")
    ...
    full_report = "# 📊 Relatório de Auditoria de Potencial, Alta Performance e Assertividade (25/03 a 27/03)\n"
    ...
    full_report += f"\n## 🏆 Resultado Final Acumulado (Período: 25/03 a 27/03): R$ {total_accumulated_pnl:.2f}\n"
    full_report += detailed_reports

    report_path = os.path.join(os.path.dirname(__file__), "audit_25_26_27_mar_results.md")
