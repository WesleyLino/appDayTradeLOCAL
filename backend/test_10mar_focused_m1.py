...
logger = logging.getLogger("TesteFocado10Mar")

async def test_focused_10mar():
    logger.info("🤖 [SOTA-v24] Iniciando Teste Focado de 1 Dia: 10/03/2026")
    ...
    # Datas: 10/03 e o dia útil anterior (09/03) para Warm-up
    date_from = datetime(2026, 3, 9, 9, 0) 
    date_to = datetime(2026, 3, 10, 18, 0)
    ...
    # [v24.4] Adicionando colunas de Microestrutura (8 canais)
    ...
    # 3. Executar
    logger.info("🚀 Executando simulação focado no dia 10/03...")
    await bt.run()
    ...
    logger.info("\n" + "="*60)
    logger.info(f"🏆 RESULTADO FOCADO - 10/03/2026")
...
if __name__ == "__main__":
    asyncio.run(test_focused_10mar())
