...
rates = mt5.copy_rates_range(symbol, mt5.TIMEFRAME_M1, date_from + timedelta(hours=3), date_to + timedelta(hours=3))
...
if rates is None or len(rates) == 0:
    ...
    s_test = "WING26"
    rates = mt5.copy_rates_range(s_test, mt5.TIMEFRAME_M1, date_from + timedelta(hours=3), date_to + timedelta(hours=3))
