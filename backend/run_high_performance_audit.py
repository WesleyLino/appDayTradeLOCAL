...
async def run_high_performance_audit():
    ...
    full_report += (
        f"**Capital Inicial**: R$ {capital_inicial:.2f} | Ativo: {symbol}\n\n"
    )
    ...
    for target_date in dates_to_test:
        ...
        ai_instance.bluechips_veto_threshold = (
            0.6  # [PERMISSIVO] Filtro Institucional Moderado
        )
        ...
        tester.opt_params["confidence_threshold"] = (
            0.75  # Threshold de Segurança (Evita ruído de 25/02)
        )
        ...
        tester.opt_params["cooldown_minutes"] = (
            5  # Cooldown reduzido (Originalmente solicitado: mais trades)
        )
