...
def run_shadow_loop():
    ...
    logger.info(f"   Frequência de análise: {SHADOW_CYCLE_SECS}s | Ações: {ACTION_NAMES}")
    ...
    if os.path.exists(weights_path):
        ...
        logger.info("⚠️  Sem pesos pré-treinados. Agent operando com política aleatória (Bootstrap).")
