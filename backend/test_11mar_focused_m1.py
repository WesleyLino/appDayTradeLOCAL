...
logger = logging.getLogger("TesteFocado11Mar")

async def test_focused_11mar():
    logger.info("🤖 [SOTA-v24] Iniciando Teste Focado de 1 Dia: 11/03/2026")
    ...
    # Datas: 11/03 e o dia útil anterior (10/03) para Warm-up
    date_from = datetime(2026, 3, 10, 9, 0) 
    ...
    # 3. Executar
    logger.info("🚀 Executando simulação focado no dia 11/03...")
    await bt.run()
    ...
    logger.info("\n" + "="*60)
    logger.info(f"🏆 RESULTADO FOCADO - 11/03/2026")
...
if __name__ == "__main__":
    asyncio.run(test_focused_11mar())
