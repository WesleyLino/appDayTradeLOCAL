...
logger = logging.getLogger("TesteFocado25Fev")

async def test_focused_25feb():
    logger.info("🤖 [SOTA-v24] Iniciando Teste Focado de 1 Dia: 25/02/2026")
    ...
    # Datas: Pegamos o dia 25/02 e o dia útil anterior (24/02) para Warm-up
    date_from = datetime(2026, 2, 24, 9, 0) 
    date_to = datetime(2026, 2, 25, 18, 0)
    ...
    # 3. Executar
    logger.info("🚀 Executando simulação focado no dia 25/02...")
    await bt.run()
    ...
    logger.info("\n" + "="*60)
    logger.info(f"🏆 RESULTADO FOCADO - 25/02/2026")
...
if __name__ == "__main__":
    asyncio.run(test_focused_25feb())
