...
async def run_7day_baseline_test():
    ...
    params['aggressive_mode'] = True # Para habilitar o rsi_threshold maior e daily_loss de 60%
    ...
    for t in backtester.trades[-10:]:
        print(f"Data: {t['exit_time'].date()} | {t['exit_time'].time()} | Side: {t['side']} | Pts: {t['pnl_points']:.1f} | R$: {t['pnl_fin']:.2f} | Motivo: {t['reason']}")
