...
logger = logging.getLogger("TesteFocado23Fev")

async def test_focused_23feb():
    logger.info("🤖 [SOTA-v24] Iniciando Teste Focado de 1 Dia: 23/02/2026")
    ...
    # Datas: Pegamos o dia 23/02 e o dia útil anterior (20/02) para Warm-up
    date_from = datetime(2026, 2, 20, 9, 0) 
    date_to = datetime(2026, 2, 23, 18, 0)
    ...
    # 3. Executar
    logger.info("🚀 Executando simulação focado no dia 23/02...")
    await bt.run()
    ...
    logger.info("\n" + "="*60)
    logger.info(f"🏆 RESULTADO FOCADO - 23/02/2026")
...
if __name__ == "__main__":
    asyncio.run(test_focused_23feb())
