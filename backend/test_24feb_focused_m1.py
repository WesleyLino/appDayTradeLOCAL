...
logger = logging.getLogger("TesteFocado24Fev")

async def test_focused_24feb():
    logger.info("🤖 [SOTA-v24] Iniciando Teste Focado de 1 Dia: 24/02/2026")
    ...
    # Datas: Pegamos o dia 24/02 e o dia útil anterior (23/02) para Warm-up
    date_from = datetime(2026, 2, 23, 9, 0) 
    date_to = datetime(2026, 2, 24, 18, 0)
    ...
    # 3. Executar
    logger.info("🚀 Executando simulação focado no dia 24/02...")
    await bt.run()
    ...
    logger.info("\n" + "="*60)
    logger.info(f"🏆 RESULTADO FOCADO - 24/02/2026")
...
if __name__ == "__main__":
    asyncio.run(test_focused_24feb())
