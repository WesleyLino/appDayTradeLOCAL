...
async def detailed_audit():
    ...
    print(f"\n{'='*60}")
    print("AUDITORIA DETALHADA: POTENCIAL DE GANHO WIN$ (23/02/2026)")
    print(f"{'='*60}")
    
    symbol = "WIN$"
    capital = 3000.0
    target_date = datetime(2026, 2, 23).date()
    ...
    for cfg in configs:
        ...
        tester = BacktestPro(
            symbol=symbol,
            n_candles=5000, # Aumentado para garantir o alcance de 23/02
            timeframe="M1",
    ...
    print("1. Análise comparativa com o início da semana (23/02).")
    print("2. Verificação de estabilidade do modelo SOTA.")
    print(f"{'='*60}\n")
