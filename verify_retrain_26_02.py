...
async def run_audit_26_02():
    ...
    trades_legacy = len(results_legacy['trades']) if results_legacy and 'trades' in results_legacy else 0
    trades_sota = len(results_sota['trades']) if results_sota and 'trades' in results_sota else 0
