...
async def run_comparative_audit():
    ...
    for res in results_v4:
        ...
        print(f"   ↳ [SOTA v4 AI Audit]: Oportunidades Filtradas (Shadow): {shadow.get('filtered_by_ai', 0)}")
        print(f"   ↳ [SOTA v4 H1 Filter]: Oportunidades Vetadas pela Tendência: {shadow.get('total_missed', 0) - shadow.get('filtered_by_ai', 0)}")
