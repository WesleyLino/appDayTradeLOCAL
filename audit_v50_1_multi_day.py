...
async def run_detailed_audit():
    ...
    dias = [
        "19_02_2026", "20_02_2026", "23_02_2026", "24_02_2026", 
        "25_02_2026", "26_02_2026", "27_02_2026", "02_03_2026"
    ]
    ...
    with open(report_path, "w", encoding="utf-8") as f:
        ...
        # Cabeçalho da Tabela
        headers = ["Data", "PnL Total", "PnL Compra", "PnL Venda", "Prejuízo", "Trades", "Vetos IA", "Max DD %"]
        ...
        if total_compra > total_venda * 1.5:
            f.write("- **Assimetria de Direção:** O bot performou melhor em COMPRAS. Sugerimos revisar o filtro de volume na VENDA.\n")
        elif total_venda > total_compra * 1.5:
            f.write("- **Assimetria de Direção:** O bot performou melhor em VENDAS. Sugerimos revisar o filtro RSI na COMPRA.\n")
            
        if total_vetos > total_pnl / 10: # Heurística de excesso de zelo
            f.write("- **Otimização de Assertividade:** A IA está vetando muitos sinais. Podemos reduzir o `confidence_threshold` em 0.05 para capturar trades de 'Sweet Spot' que estão sendo ignorados.\n")
            
        f.write("- **Gestão de Risco:** O Prejuízo bruto de R$ {:.2f} sugere que o Trailing Stop está protegendo bem o capital em dias voláteis.\n".format(abs(total_prejuizo)))
