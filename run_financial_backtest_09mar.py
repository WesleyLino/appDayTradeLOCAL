...
def run_simulation():
    ...
    print(f"Analisando Dia 09/03 no {SYMBOL_CONTINUO} / {SYMBOL_CONTRAT} - Capital R$ {CAPITAL:.2f}")
    ...
    if not df.empty:
        ...
        print("Sem dados para a data especificada. O MT5 precisa estar conectado e o ativo WING26 / WINJ26 liberado no market watch.")
        mt5.shutdown()
        return
