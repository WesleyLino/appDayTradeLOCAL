...
def verify_meta_filter():
    ...
    logging.info(f"Resultado: Direction={decision_veto['direction']}, Score={decision_veto['score']:.2f}")
    logging.info(f"   Breakdown Meta: prob={decision_veto['breakdown'].get('meta_score'):.2f}, veto={decision_veto['breakdown'].get('veto')}")
    ...
    logging.info(f"Resultado: Direction={decision_ok['direction']}, Score={decision_ok['score']:.2f}")
